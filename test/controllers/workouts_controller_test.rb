...
class WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post workouts_url, params: { workout: { sport_id: @workout.sport_id, user_id: @workout.user_id } }
    end
  ...
  test "should update workout" do
    patch workout_url(@workout), params: { workout: { sport_id: @workout.sport_id, user_id: @workout.user_id } }
